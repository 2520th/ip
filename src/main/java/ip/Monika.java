...
public class Monika {
     ...
     * @param input is the string input from what user enters into textfield and send
     * @return response generated by executor or special states such as asking for username input
     */
    public String getResponse(String input) throws IOException {
        ...
        // Illegal names -> ask user to input again
    ...
    // Invoked only when user exits the program by saying bye -> executor returns null
